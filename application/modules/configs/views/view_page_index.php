        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="f-cat" role="form" action="<?php echo get_admin_url('settings'); ?>" method="post" autocomplete="off">
                    ...
                    <?php $has_error = (form_error('instagram_page') != '' ? ' has-error' : ''); ?>
                    <div class="form-group required<?php echo $has_error; ?>">
                        <label for="instagram_page" class="control-label">Instagram</label>
                        <?php $configs_instagram_page = (set_value('instagram_page') != '') ? set_value('instagram_page') : $configs['instagram_page']; ?>
                        <input class="form-control" name="instagram_page" id="instagram_page" type="text" value="<?php echo $configs_instagram_page; ?>">
                        <?php echo form_error('instagram_page'); ?>
                    </div>
                    ...
                    <?php 
						$arr_configs_cod = @unserialize($configs['cod']);
						$configs_cod_title = isset($arr_configs_cod['title']) ? $arr_configs_cod['title'] : '';
						$configs_cod_info = isset($arr_configs_cod['info']) ? $arr_configs_cod['info'] : '';
					?>
					<div class="row">
						<div class="col-md-4"> 
							<div class="form-group required">
								<label class="control-label">Thanh toán tiền mặt(Tiêu đề)</label>
								<input class="form-control" name="cod[title]" type="text" value="<?php echo $configs_cod_title; ?>">
							</div>
						</div>
						<div class="col-md-8"> 
							<div class="form-group required">
								<label class="control-label">Thanh toán tiền mặt(Nội dung)</label>
								<input class="form-control" name="cod[info]" type="text" value="<?php echo $configs_cod_info; ?>">
							</div>
						</div>
					</div>

					<?php 
						$arr_configs_bacs = @unserialize($configs['bacs']);
						$configs_bacs_title = isset($arr_configs_bacs['title']) ? $arr_configs_bacs['title'] : '';
						$configs_bacs_info = isset($arr_configs_bacs['info']) ? $arr_configs_bacs['info'] : '';
					?>
					<div class="row">
						<div class="col-md-4"> 
							<div class="form-group required">
								<label class="control-label">Chuyển khoản ngân hàng(Tiêu đề)</label>
								<input class="form-control" name="bacs[title]" type="text" value="<?php echo $configs_bacs_title; ?>">
							</div>
						</div>
						<div class="col-md-8"> 
							<div class="form-group required">
								<label class="control-label">Chuyển khoản ngân hàng(Nội dung)</label>
								<input class="form-control" name="bacs[info]" type="text" value="<?php echo $configs_bacs_info; ?>">
							</div>
						</div>
					</div>
                    ...
                    <div class="form-group">
                        <label for="site_content_contact" class="control-label">Nội dung thông tin liên hệ</label>
                        <?php
