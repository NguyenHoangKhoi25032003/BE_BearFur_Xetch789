										...
										<div class="box-profile">
											...
											<form id="f-profile" action="<?php echo current_full_url(); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
												<div class="block-wapper--title">
													<h2>Chia sẻ đăng ký thành viên</h2>
												</div>
				                                <div class="row form-group">
				                                    ...
				                                    <div class="col-lg-8 col-md-8 col-sm-12">
				                                        <div class="input-group">
				                                            <input type="text" class="form-control" value="<?php echo isset($row['refer_key']) ? $row['refer_key'] : ''; ?>" id="share-username" readonly>
				                                            <span class="input-group-btn">
				                                                <button type="button" class="btn btn-primary btn-copy" data-clipboard-action="copy" data-clipboard-target="#share-username"><i class="fa fa-copy" aria-hidden="true"></i></button>
				                                            </span>
				                                        </div>
				                                    </div>
				                                </div>
				                                <div class="row form-group">
				            					  	<div class="col-lg-4 col-md-4 col-sm-12">
				            							<p class="account-change-email_header" style="font-weight: 700; color: #f00;">Link chia sẻ của bạn</p>
				            					  	</div>
				            					  	<div class="col-lg-8 col-md-8 col-sm-12">
				            			              	<div class="input-group">
				            			                	<input class="form-control" type="text" value='<?php echo isset($row['refer_key']) ? site_url('dang-ky') . '?ref=' . $row['refer_key'] : ''; ?>' id="link-share-username" readonly>
				            			                	<span class="input-group-btn">
				            			                	  	<button type="button" class="btn btn-primary btn-copy" data-clipboard-action="copy" data-clipboard-target="#link-share-username"><i class="fa fa-copy" aria-hidden="true"></i></button>
				            			                	</span>
				            			            	</div>
				            					  	</div>
				            					</div>
