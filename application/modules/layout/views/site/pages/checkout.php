                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-7 col-md-8 col-sm-8">
                                <div class="checkout-warpper">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label>Tên <abbr class="required" title="Bắt buộc">*</abbr></label>
                                                <input type="text" class="form-control" name="address_full_name" value="" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label>Số điện thoại <abbr class="required" title="Bắt buộc">*</abbr></label>
                                                <input type="text" class="form-control" name="address_phone" value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label>Địa chỉ nhận hàng (tầng, số nhà, đường) <abbr class="required" title="Bắt buộc">*</abbr></label>
                                                <input type="text" class="form-control" name="place_of_receipt" value="" required>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="province_id" id="el-province-shipping">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="district_id" id="el-district-shipping">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group">
                                                <label>Phường/xã <abbr class="required" title="Bắt buộc">*</abbr></label>
                                                <select class="form-control" name="commune_id" id="el-commune-shipping">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="el-checkout-with-other-info" name="is_checkout_with_other_info" value="1">
                                                    <label class="form-check-label" for="el-checkout-with-other-info" style="cursor: pointer;">
                                                        Thông tin thanh toán khác với thông tin giao hàng
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php endif; ?>
                                    <h3 class="title container-checkout-with-other-info d-none">THÔNG TIN THANH TOÁN</h3>
                                    <div class="row container-checkout-with-other-info d-none">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label>Họ và tên <abbr class="required" title="Bắt buộc">*</abbr></label>
                                                <input type="text" class="form-control" name="full_name" value="<?php echo isset($user['full_name']) ? $user['full_name'] : ''; ?>" placeholder="Họ và tên" size="35">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label>Số điện thoại <abbr class="required" title="Bắt buộc">*</abbr></label>
                                                <input type="text" class="form-control" name="phone" value="<?php echo isset($user['phone']) ? $user['phone'] : ''; ?>" placeholder="Số điện thoại" size="35">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Ghi chú đơn hàng" name="order_note"
                                ...
                                <div class="block-totalcart">
                                    ...
                                    <div class="box-payment">
                                        <ul>
                                            ...
                                            <li>
                                                <input id="payment_method_<?php echo $key; ?>" type="radio"
                                                    value="<?php echo $key; ?>" name="forms_of_payment"
                                                    <?php echo $i==1 ? ' checked="checked"' : ''; ?>>
                                                <label
                                                    for="payment_method_<?php echo $key; ?>"><?php echo $payment['title']; ?></label>
