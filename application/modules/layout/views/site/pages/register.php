    ...
    <section>
        <div class="box-user">
            <div class="container">
                        ...
                        <div class="row">
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="phone" id="f-register-phone">
								</div>
                			</div>
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div
                                    ...
                                    <input type="password" class="form-control" name="password" id="f-register-password">
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="ref" value="<?php echo $is_ref ? $ref : ''; ?>"<?php echo $is_ref ? ' readonly="readonly"' : ''; ?>>
								</div>
							</div>
                        </div>
				...
				<?php echo isset($info_contact_footer_none['content']) ? $info_contact_footer_none['content'] : ''; ?>
