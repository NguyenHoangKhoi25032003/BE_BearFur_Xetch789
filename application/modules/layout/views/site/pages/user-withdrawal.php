                                            ...
                                            <div class="account-change-email">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <input class="form-control mask-price" type="text"
                                                                name="amount" value=""
                                                                placeholder="Số tiền rút là bội số của 50.000">
                                                ...
                                                <div style="text-align:center; border: solid 1px grey;margin:20px;">
                                                    <p>(*)Lưu ý: Thành viên vui lòng nhập thông tin tài khoản ngân hàng
                                                        ...
                                                        Thời gian nhận thanh toán từ 4 phút đến 24h<br>
                                                        Nếu sau 24h mà tài khoản chưa có tiền vui lòng liên hệ Bộ phần
                                                        kế toán: 090 954 2325 để được hỗ trợ.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
