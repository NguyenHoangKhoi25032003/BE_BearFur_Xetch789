                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $role_label = $this->config->item('role_label');
                                    $level = $this->config->item('level');
                                    $level_label = $this->config->item('level_label');
                                    ?>
                                    <?php foreach ($rows as $row): ?>
                                    <?php $is_member = ($row['role'] == 'MEMBER') ? TRUE : FALSE; ?>
                                    <tr>
                                        <td class="text-right">
                                            <?php echo $row['userid']; ?>
                                            <?php echo ($is_member && $row['referred_by'] > 0) ? display_label($row['referred_by']) : ''; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <?php echo display_label(display_value_array($role, $row['role']), display_value_array($role_label, $row['role'])); ?>
                                            <?php echo display_label(display_value_array($level, $row['level']), display_value_array($level_label, $row['level'])); ?>
                                        </td>
