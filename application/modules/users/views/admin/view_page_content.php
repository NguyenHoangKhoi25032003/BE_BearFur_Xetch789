                ...
                <form id="f-user-add" role="form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="level">
                                    <?php echo get_option_select($this->config->item('level'), isset($row['level']) ? $row['level'] : ''); ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="input-group">
                            <select class="form-control" name="products[]" id="products-id" multiple="true">
                            </select>
							<span class="input-group-btn">
								<button type="button" class="btn btn-info btn-select-all">Chọn tất cả</button>
							</span>
						</div>
					</div>
...
<script>
    ...
    <?php if (isset($products) && is_array($products) && !empty($products)): ?>
        ...
        <?php endforeach; ?>
    <?php endif; ?>
    // console.log(initialPropertyOptions);
</script>