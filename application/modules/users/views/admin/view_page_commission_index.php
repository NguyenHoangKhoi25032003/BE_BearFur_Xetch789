                                    ...
                                    <?php foreach ($rows as $row): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(in_array($action, array('SUB_BUY', 'SUB_BUY_REFERRED_ROOT', 'SUB_BUY_REFERRED'))): ?>
                                                    <br/>
                                                    <?php echo display_label('#ID-' . $row['order_id'] . '-' . $row['order_code'], 'info'); ?>
                                                <?php elseif($action == 'WITHDRAWAL'): ?>
                                                <p>
                                                    Số dư khả dụng: <?php echo formatRice(get_balance_user($user_id)); ?>
                                                    <br/>
                                                    <?php echo get_bank_info($user_id); ?>
                                                </p>
                                                <?php endif; ?>
                                                <?php
