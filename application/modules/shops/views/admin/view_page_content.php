                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-9">
                            ...
                            <div class="row">
                            	...
                            	<div class="col-md-3">
		                            <div class="form-group">
		                                ...
		                                <input type="text" class="form-control text-right" name="product_discount_percent" value="<?php echo isset($row['product_discount_percent']) ? $row['product_discount_percent'] : ''; ?>">
		                            </div>
                            	</div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Hoa hồng CTV (%)</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Hoa hồng sỉ (%)</label>
                                        <input type="text" class="form-control text-right" name="commission_wholesale" value="<?php echo isset($row['commission_wholesale']) ? $row['commission_wholesale'] : ''; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
												...
												<div style="margin-bottom: 2px;">
                                                    <input class="flat-blue" type="checkbox" value="1" name="is_featured"<?php echo (isset($row['is_featured']) && $row['is_featured'] == 1) ? ' checked="checked"' : ''; ?>>
                                                    <label>Nổi bật</label>
                                                </div>
                                                <div style="margin-bottom: 2px;">
												...
												<div style="margin-bottom: 2px;">
                                                    <input class="flat-blue" type="checkbox" value="1" name="status"<?php echo (isset($row['status']) && $row['status'] == 0) ? '' : ' checked="checked"'; ?>>
