    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box box-primary" id="element-print">
                                ...
                                <td style="border-top: none;">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr style="color: #1551bf; font-weight: 700;">
                                                <td>Người giới thiệu:</td>
                                                <td><?php echo isset($order['ref_full_name']) ? $order['ref_full_name'] . (trim($order['ref_username']) != '' ? ' (' . $order['ref_username'] . ')' : '') : '-'; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
            ...
            <div class="text-center noPrint" id="btn-group-action">
                <?php if ($is_role_full_access && $order['transaction_status'] == 0): ?>
